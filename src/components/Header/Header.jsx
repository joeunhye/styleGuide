		...
		<header className={cx("header", deviceStyle)}>
			...
			{pathName === "" || pathName === "icons" ? (
				...
				<div className={cx("device", { dark: darkMode }, deviceStyle)}>
					<button data-device="mobile" onClick={e => handleDeviceMode(e)}>
						<CiMobile2 size={25} />
					</button>
					<button data-device="tablet" onClick={e => handleDeviceMode(e)}>
						<BsTabletLandscape size={20} />
					</button>
					<button data-device="desktop" onClick={e => handleDeviceMode(e)}>
